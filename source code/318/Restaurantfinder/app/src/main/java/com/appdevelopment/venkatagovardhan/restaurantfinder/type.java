    ...
    public class BackgroundActivity extends AsyncTask<String, String, Void> {
        ...
        protected void onPostExecute(Void result) {
            ...
            try {
                ...
                JSONArray resultObject = new JSONArray(resultConnection);
//                TypeArray =resultObject.getString(0);
                JSONArray TObject=resultObject.getJSONArray(0);




                JSONObject TypeArray1 = new JSONObject(TypeArray);
                JSONArray TypeArray2=TypeArray1.getJSONArray("item");


                for (int i = 0; i < TypeArray2.length(); i++) {

                    JSONObject json = TypeArray2.getJSONObject(i);
